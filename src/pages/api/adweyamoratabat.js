...
export default async function handler(req, res) {
  ...
  try {
    ...
    var xx='AND PRESCRIPTION_MEDICINE_MON.CLINIC_CODE IN (30209110001, 30209130001, 20090160001)'
    if (TYPE_IN == 3) {
      xx = 'AND PRESCRIPTION_MEDICINE_MON.CLINIC_CODE NOT IN (30209110001, 30209130001, 20090160001)'
    }
