    ...
    >
      <div style={{ paddingInline: "15%" }}>
        <div id="pdf-container">
          <h1 style={{ marginBottom: 20, color: "#F0ECE5" }}>وافدين داخلي </h1>
          <div
            style={{
              display: "grid",
          ...
          {rows.length <= 0 ? (
            ...
            >
              <MyDocument
                data={rows}
                title={`
                بيانات الوافدين الأجانب الذين تم حجزهم داخل المجمع خلال الفترة من  ${staticStartDate} الي ${staticEndDate}`}
              />
            </DynamicPDFViewer>
          )}
        </div>
