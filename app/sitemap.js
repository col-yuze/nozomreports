...
export default async function sitemap() {
  ...
  const transformedSlugs = siteSlugs.flatMap((siteSlug) => {
    return siteSlug.flatMap((pageSlug) => {
      return {
        url: `https://www.nozomreports.dev/${pageSlug}`,
  ...
  return [
    {
      url: 'https://www.nozomreports.dev',
      lastModified: new Date(),
    },
    {
      url: 'https://www.nozomreports.dev/about/faqs',
      lastModified: new Date(),
    },
    {
      url: 'https://www.nozomreports.dev/about/acknowledgements',
      lastModified: new Date(),
    },
    {
      url: 'https://www.nozomreports.dev/blog',
      lastModified: new Date(),
    },
    ...transformedSlugs,
  ]
